...
const WhatsAppBtn = () => {
  ...
  return (
    // FIX 1: Lowered z-index from 9999 to 50 (So it sits under Preloader)
    <div className="fixed bottom-8 right-8 z-[50] flex items-center gap-4">
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="bg-white text-black px-4 py-2 rounded-xl shadow-xl font-medium text-sm hidden md:block whitespace-nowrap"
          >
            Chat with us
          </motion.div>
        )}
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
      >
        {/* FIX 2: Used inline style for animation duration. duration-[5s] does not work on animate-ping */}
        <span
